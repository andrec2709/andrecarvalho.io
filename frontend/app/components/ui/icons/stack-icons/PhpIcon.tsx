...
export default function PhpIcon({ color = 'none', size = 24, ...props }: IconProps) {
    const id = useId();
    ...
    return (
        ...
        >
            ...
            <g clipPath={`url(#${id}-a)`} transform="matrix(1.25 0 0 -1.25 -4.4 394.299)">
                <path
            ...
            <g clipPath={`url(#${id}-c)`} transform="matrix(1.25 0 0 -1.25 -4.4 394.299)">
                <path
            ...
            <g clipPath={`url(#${id}-d)`} transform="matrix(1.25 0 0 -1.25 -4.4 394.299)">
                <path
