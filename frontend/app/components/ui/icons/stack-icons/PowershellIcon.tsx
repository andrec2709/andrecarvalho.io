...
export default function PowershellIcon({ color = 'none', size = 24, ...props }: IconProps) {
    return (
        <svg
        ...
        >
            <path
                d="M120.14.032c23.011-.008 46.023-.078 69.034.019 13.68.056 17.537 4.627 14.588 18.137-8.636 39.566-17.466 79.092-26.415 118.589-2.83 12.484-9.332 17.598-22.465 17.637-46.023.137-92.046.152-138.068-.006-15.043-.053-19-5.148-15.759-19.404A39065.945 39065.945 0 0 1 27.602 18.892C30.997 4.148 36.099.1 51.104.057 74.116-.008 97.128.04 120.14.032z"
                style={{
                    fillRule: "evenodd",
                    clipRule: "evenodd",
                    fill: "#e0eaf5",
